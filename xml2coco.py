...
def main():
    xml_path = '/Users/clustar/Desktop/项目/金盛兰数据新/吸盘/20210718_label_test' #xml
    print('xml_path: ', xml_path)
    # xml_path = '../../../Datasets/underwater/data0/18test/label'
    img_path = '/Users/clustar/Desktop/项目/金盛兰数据新/吸盘/20210718_test' #img
    # img_path = '../../../Datasets/underwater/data0/18test/image'
    print('processing {} ...'.format("xml format annotations"))
    cvt_annotations(img_path, xml_path, '/Users/clustar/Desktop/项目/金盛兰数据新/吸盘/train.json')  # json
